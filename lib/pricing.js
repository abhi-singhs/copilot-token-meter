...
// Per-model pricing — purely a rough estimate.
//
// ⚠  DISCLAIMER: the USD numbers this module produces are a *guesstimate*
//   based on publicly listed Anthropic / OpenAI prices for the matched
//   model. They are NOT a bill and may be substantially wrong because:
//
//     * GitHub Copilot's routing layer applies its own billing weights and
//       premium-request quotas that have no public USD conversion. The
//       authoritative cost lives in `/usage` inside Copilot CLI.
//     * Enterprise plans, BYOK keys, partner discounts, and promotional
//       credits are all invisible to this module.
//     * Anthropic exposes both 5-minute and 1-hour cache TTL pricing tiers;
//       we always use the 5-minute rate.
//     * The published list price for each model can change at any time.
//
// Treat the USD figure as a relative sanity check across tools/turns,
// never as a number to put in a budget.
//
